...
```
```{r}
#According to the degree metric, Xixuan Zhao has the greatest number of links to other individuals or nodes in the class network. Likewise, Xixuan Zhao has the greatest betweenness centrality, Thus, Xixuan is the most central person in the network. As in, she shares the most amount of classes with other students. 
```
